...
public class GetBooking extends BaseTest {
	...
	public void getBookingIDs(String ID, 
		...
		step("Starting the test to get booking details");
		/*******************************************************
		...
		step("Getting the response for the Booking IDs from test data excel");
		...
		step("Asserting of response body with the data from test data excel");
